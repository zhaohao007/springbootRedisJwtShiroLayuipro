...
layui.define(['form', 'authtree'], function (exports) {
    ...
    $getAjaxWithJson("/api/admin/role/get/"+router.search.roleId,null,function (resultData) {
        $("#id").val(resultData.id);
        $("#roleName").val(resultData.roleName);
        $("#remark").val(resultData.remark);
    })

    $getAjaxWithJsonSynch('/api/admin/role/edite/choose/'+router.search.roleId,null,function (resultData) {
    ...
    form.on('submit(LAY-auth-tree-submit)', function(obj){
        ...
        $postAjaxWithJson("/api/admin/role/edite",obj.field,function(data){
